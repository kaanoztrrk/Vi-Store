class ViFirebaseAuthException implements Exception {
  final String code;

  ViFirebaseAuthException(this.code);
  ...
  String get message {
    switch (code) {
      ...
      case 'credential-already-in-use':
        return 'This credential is already associated with a diferent user account.';
      case 'user-mismatch':
      ...
      case 'missing-action-code':
        return 'The aciton code is missing. Please prrovide a valid aciton code.';
